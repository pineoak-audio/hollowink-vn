    ...
    async onCall(params) {
      if (params.body == "REMOVE" && this.scorer){
        ...
        if (this.scorer){
            ...
            this.scorer = this.game.add.sprite(this.game.world.centerX+485, this.game.world.centerY-300, 'scorer'); //loads scorer gui under extras
            ...
            this.text = this.game.add.text(0, 2.5, message, style);
...
// - var score: "{score} - 50" || ATUALIZA VARIAVEL
// - call Scorer: "{score}"    || CHAMA SCORE


// RenJS created by  lunafromthemoon 
// openMenu saveloadstartopenMenu settings